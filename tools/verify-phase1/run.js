// tools/verify-phase1/run.js — chạy test cho tầng nghiệp vụ của gas_phase_1/.
//
...
//
// Chạy: node tools/verify-phase1/run.js [--data]
const fs = require('fs');
...
const PURE_FILES = [
  ...
  'shared/engine.js',
  'shared/sheet.js',
  'gas_phase_1/0_config.js',
  'gas_phase_1/3_sources.js',
  'gas_phase_1/4_customer_master.js',
  'gas_phase_1/5_copyright_master.js',
  'gas_phase_1/6_matching.js',
  'gas_phase_1/7_warnings.js',
];
